...
const AuthLayout = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-blue-100 dark:from-gray-950 dark:to-gray-900 px-4 py-8 sm:py-12">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Store Rating</h1>
